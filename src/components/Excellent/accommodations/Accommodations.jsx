...
const Accommodations = () => {
  return (
    <>
      <section className="w-[96%] mt-[37px] m-auto h-[446px]  relative bottom-[-230px]">
        <div className=" w-[96%]  flex flex-col  pb-[22px] m-auto">
              ...
              <span>
                <svg className="w-[60px]">
                  <path
                    ...
                    className="w-[40px] h-[40px] fill-blue-600"
                  ></path>
                  <path
                    ...
                    className="w-[40px] h-[40px] fill-blue-800 "
                  ></path>
                  <path
          ...
          <div className="flex items-center p-[3px] justify-between mt-[16px] w-[97%] m-auto rounded-[5px] border-[1px] border-solid border-gray-400">
            <div className="h-[58px]">
              <span className="52px mt-[3px]">
                <svg className="w-[60px] fill-blue-600 h-[53px]">
       
                  <svg
                    className="sc-679cb2a8-0 kHcjkr"
                    fill="none"
                    viewBox="0 0 52 54"
