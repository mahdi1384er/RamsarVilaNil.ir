              ...
              <tbody className="relative ">
                <div>
                  ...
                  <div className="mt-[10px]">
                    <span>
                      مبلغ پرداختی شما نزد رامسرباما محفوظ است. درصورتی که
            ...
            <table className="w-[100%] mt-[48px] h-[370px] m-auto flex items-center justify-center shadow-xl rounded-[15px]">
              <tbody className="relative ">
                <div>
                  ...
                  <div className="mt-[10px]">
                    <span>
                      مبلغ پرداختی شما نزد رامسرباما محفوظ است. درصورتی که اقامتگاه
                      ...
                      امکان پیگیری را برای پشتیبانی رامسرباما فراهم نمایید. (پس از
            ...
            <table className="w-[100%] mt-[48px] h-[370px] m-auto flex items-center justify-center shadow-xl rounded-[15px]">
              <tbody className="relative ">
                <div>
                  ...
                  <div className="mt-[10px]">
                    <span>
                      مبلغ پرداختی شما نزد رامسرباما محفوظ است. درصورتیکه اقامتگاه
                      ...
                      برای پشتیبانی رامسرباما فراهم نمایید. (پس از پایان مهلت
          ...
          <table className="flex items-center justify-center relative top-[10px]">
            <tbody>
              <div className="w-[192px] h-[40px] p-2 rounded-[6px] bg-blue-600 text-white relative top-[10px] flex items-center justify-between">
                <a href="tel:09300616152" class="bt text-white flex items-center justify-between w-[100%]">
