...
import SerchboxBlogs from "./serchbox";
        ...
        <Modal.Header>
          <div>
            <form className="flex items-center">
              <input
                className="search h-[18px] border-solid border-[1px] border-gray-300 focus:border-blue-400  focus:border-[2px] w-[324px] mr-[20px]  p-[11px] pt-[19px] pb-[17px] rounded-[16px] bg-white text-[#8D8E8F] text-[12px] font-bold focus:outline-none"
