      ...
      <tbody className="serchs">
        {data.map((item) => (
           <NavLink to={{ pathname: item.path, search: `/${item.title}/` }}>
            <div className="w-[280px] h-[70px] rounded-[5px] border-solid border-[1px] border-gray-600 mt-[20px] pr-[10px]">
              <tr key={item.id} className="flex items-center justify-between">
                ...
                <div>
                  <td className="text-white">
                    <img src={item.img} alt="" className="w-[120px] h-[70px] rounded-[5px]" />
                  </td>
                </div>
              </tr>
            </div>
