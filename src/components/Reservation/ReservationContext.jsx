...
const ReservationContext = () => {
  return (
    <section className="w-[90%] mt-[9px] h-[247px] m-auto">
      <div className="w-[100%]   m-auto">
        <div className="flex flex-col">
          ...
          <div className="flex w-[120%] items-center justify-between overflow-scroll mt-[6px] ml-[-11px] mr-[0] relative bottom-[28px] right-[-6px]">
            <ReservationItems />
          </div>
        </div>
      </div>
