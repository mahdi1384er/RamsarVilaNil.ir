    ...
    (
      <section>
        <div className="w-[100%] m-auto flex items-center flex-col">
          ...
          <Swiper
            className="wiper container testimonials__container  h-[500px]"
          ...
          >
            {data.map((item, index) => {
              return (
                <SwiperSlide
                  key={index}
                  className="ml-[350px] pl-[95px] pr-[10px] testimonials"
                >
                  <div className="mr-[75px] w-[100%] h-[303px] shadow-lg border-solid border-[1px] text-[#818181] mt-[30px] rounded-[10px] flex flex-col ">
                    ...
                    <div className="flex items-center justify-between relative bottom-[21px]  w-[95%] pr-[13px]">
